...
// Vídeos de amostra (neutros) usados no MODO DEMO, quando Bunny/Supabase não estão configurados.
...
// No modo demo, e-mails contendo "vip" ou "pago" têm acesso total (simula comprador).
